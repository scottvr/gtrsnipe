...
| `mary-london.tab` | Mary → London Bridge | Richness 6: all six strings, each carrying its own interval. London Bridge's dotted rhythm needs `--homograph-rhythm 2`, and the tab carries Mary's rhythm. |
